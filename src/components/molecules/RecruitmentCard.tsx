...
export const RecruitmentCard: VFC<Props> = memo((props) => {
  ...
  const distanceToNow = formatDistanceToNow(new Date(recruitment.updatedAt), { locale: ja }).replace(/約/g, '');
  ...
  return (
    ...
    >
      ...
      <Box minHeight={110} bgcolor={'#f0f5f4'} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          ...
          {!!recruitment.capacity && (
            <Box sx={{ fontSize: 10 }} mt={2}>
              ...
              <Box ml={1} px={1} py={0.5} borderRadius={1} component="span" bgcolor="#f0f5f4">
                ...
                <Box component="span">{`0 / ${recruitment.capacity}`}</Box>
              </Box>
            </Box>
          )}
          <Box sx={{ fontSize: 10 }} mt={2}>
            ...
            <Box ml={1} px={1} py={0.5} borderRadius={1} component="span" bgcolor="#f0f5f4">
              ...
              <Box component="span">{recruitment.closingAt}</Box>
            </Box>
          </Box>
          {recruitment.startAt && (
            <Box sx={{ fontSize: 10 }} mt={2}>
